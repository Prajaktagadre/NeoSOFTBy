                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-content collapse show">
                                        ...
                                        <button id="addRow" class="btn btn-primary mb-2" onclick="window.location='{{route('staffLeaveMagement/create')}}'"><i class="ft-plus"></i>&nbsp; Add</button>
