...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('web/admin/app-assets/css/pages/login-register.css')}}">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu 1-column  bg-full-screen-image blank-page blank-page" data-open="click" data-menu="vertical-menu" data-color="bg-gradient-x-purple-blue" data-col="1-column">
                            ...
                            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                <div class="card-header border-0">
                                    <div class="text-center mb-1">
                                        <img src="{{asset('web/admin/app-assets/images/logo/logo.png')}}" alt="branding logo">
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post" action="{{route('login')}}" novalidate>
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="text" class="form-control round" name="user_name" id="user_name" placeholder="Your User Name">
    ...
    <script src="{{asset('web/admin/app-assets/vendors/js/forms/validation/jqBootstrapValidation.js')}}" type="text/javascript"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{asset('web/admin/app-assets/js/scripts/forms/form-login-register.js')}}" type="text/javascript"></script>
    <!-- END: Page JS-->
